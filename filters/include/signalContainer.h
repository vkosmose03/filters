/*
    ...
    * It contain the signal and all charestiristics.
    *
 ...
 * @memberof filteredSignal_ - is the filtered signal data.
 ...
 * @memberof rawSum_ - is the sum of the raw signal data.
 * @memberof filteredSum_ - is the sum of the filtered signal data.
 *
